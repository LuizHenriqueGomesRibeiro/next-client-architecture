import { ApiClientInstanceType, PrimitiveClient } from "../src/api/client";
import { PrimitiveServer, ServerInstanceType } from "../src/api/server";
import { MethodProps } from "../src/api/types";
